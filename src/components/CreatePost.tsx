...
//     location?: string;
//     imagePath?: string;
//   }) => Promise<void>; // חשוב: הבטחה (Promise) כדי לאפשר טיפול בטעויות
// }
...
//           <AddPhotoAlternateIcon />
//           <Typography variant="caption">
//             {imagePath ? "Image selected!" : "Click or drag to upload image"}
//           </Typography>
//         </div>

//         {imagePath && (
//           <img src={imagePath} alt="Preview" className="image-preview" />
//         )}
//       </DialogContent>
//       <DialogActions>
//         <Button onClick={onClose} color="inherit">
